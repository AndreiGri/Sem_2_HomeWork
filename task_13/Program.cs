...
{
    long num1 = (num / 100) % 10;                                                     // Введённое число делим на сто и из полученного значения без остатка вычисляем остаток при делении на десять.
    if(num < 0) num1 = num1 * -1;                                                    // Проверяем введённое число на знак по модулю и в случяе отрицательного значения умножаем результат на минус один для приведения к положительному значению.
